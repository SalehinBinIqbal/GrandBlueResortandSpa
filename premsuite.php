...
<head>
    ...
    <title>GrandBlue Resort & Spa / Premium Suite</title>
</head>
        ...
        <div class="commonheader">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade topcarousel" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <?php 
                            while($data = mysqli_fetch_array($banner_prsuite))
                                {  ?>           
                                    <img src="<?php echo $data['img_path'] ?>" class="d-block w-100" alt="...">  
                            
                            <?php } ?>
                        
                        <!-- <img src="images/Rooms & Suites/PremiumSuite/banner_prsuite.png" class="d-block w-100" alt="..."> -->
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="blocksubtext">
                                The Premium Suite is the epitome of luxury and elegance. Featuring a spacious bedroom, large living and dressing areas, an en suite stone-lined bathroom with bathtub and rain shower, plus a private balcony with views over the sea to the horizon. These 128sqm suites are the ideal choice for the discerning traveler. 
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="row row-cols-1">
                        <a href="images/Rooms & Suites/PremiumSuite/Suite2.jpg" data-lightbox="mygallery">
                        <?php 
                            while($data = mysqli_fetch_array($Suite2))
                                {  ?>           
                                    <img src="<?php echo $data['img_path'] ?>" width="100%" alt="">  
                            
                        <?php } ?>
                            <!-- <img src="images/Rooms & Suites/PremiumSuite/Suite2.jpg" width="100%" alt=""> -->
                        </a>
                    </div>
                    <div class="row row-cols-1 allsmallroompics">
                        <div class="col-sm-4 roompics">
                            <a href="images/Rooms & Suites/PremiumSuite/Suite2_1.jpg" data-lightbox="mygallery">
                            <?php 
                            while($data = mysqli_fetch_array($Suite2_1))
                                {  ?>           
                                    <img class="smallimg" src="<?php echo $data['img_path'] ?>" width="100%" alt="">  
                            
                            <?php } ?>
                                <!-- <img class="smallimg" src="images/Rooms & Suites/PremiumSuite/Suite2_1.jpg" width="100%" alt=""> -->
                            </a>
                        </div>
                        <div class="col-sm-4 roompics">
                            <a href="images/Rooms & Suites/PremiumSuite/Suite2_2.jpeg" data-lightbox="mygallery">
                            <?php 
                            while($data = mysqli_fetch_array($Suite2_2))
                                {  ?>           
                                    <img class="smallimg" src="<?php echo $data['img_path'] ?>" width="100%" alt="">  
                            
                            <?php } ?>
                                <!-- <img class="smallimg" src="images/Rooms & Suites/PremiumSuite/Suite2_2.jpeg" width="100%" alt=""> -->
                            </a>
                        </div>
                        <div class="col-sm-4 roompics">
                            <a href="images/Rooms & Suites/PremiumSuite/Suite2_3.jpeg" data-lightbox="mygallery">
                            <?php 
                            while($data = mysqli_fetch_array($Suite2_3))
                                {  ?>           
                                    <img class="smallimg" src="<?php echo $data['img_path'] ?>" width="100%" alt="">  
                            
                            <?php } ?>
                                <!-- <img class="smallimg" src="images/Rooms & Suites/PremiumSuite/Suite2_3.jpeg" width="100%" alt=""> -->
                            </a>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="roominfo">
                                ...
                                <li>
                                    Bathtub, rain shower and dual washbasins
                                </li>
                                <li>
                                    Air conditioning and ceiling fan
                                </li>
                                <li>
                                    Full amenities and toiletries
                                </li>
                                <li>
                                    Safe deposit box
                                </li>
                                <li>
                                    300 thread count Irish Cotton Bed linen
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                            <ul class="roominfo">
                                ...
                                <li>
                                    Mini bar, tea making station and water kettle
                                </li>
                                <li>
                                    Complimentary water, fruits, flowers, French Dammann teas and Nespresso machine daily capsules
                                </li>
                                <li>
                                    Luggage cabinet with various items: slippers, beach bag, sun shade etc
                                </li>
                                <li>
                                    Wardrobe with essential items: bathrobe, kimono, torchlight, ironing set etc
                                </li>
                                <li>
                                ...
                                <li>
                                    Super comfortable Sealy Mattress
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4 text-center">
                        <?php 
                            while($data = mysqli_fetch_array($Suite2_4))
                                {  ?>           
                                    <img src="<?php echo $data['img_path'] ?>" width="100%" alt="">  
                            
                            <?php } ?>
                            <!-- <img src="images/Rooms & Suites/PremiumSuite/Suite2_4.jpg" width="100%"  alt=""> -->
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row row-cols-4">
                                        <div class="col-sm-3">
                                            <a href="https://www.facebook.com" target="_blank">
                                                <img id="fb" data-toggle="tooltip" data-placement="bottom"
                                                    title="Facebook" src="images/commonimages/facebook.svg" width="50px"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            <a href="https://www.instagram.com" target="_blank">
                                                <img id="ig" data-toggle="tooltip" data-placement="bottom"
                                                    title="Instagram" src="images/commonimages/instagram.svg"
                                                    width="50px" alt="">
                                            </a>
                                        </div>
                                        <div class="col-sm-3">
                                            <a href="https://www.discord.com/login" target="_blank">
                                                <img id="dc" data-toggle="tooltip" data-placement="bottom"
                                                    title="Discord" src="images/commonimages/discord.svg" width="50px"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
